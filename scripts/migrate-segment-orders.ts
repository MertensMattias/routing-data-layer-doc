 ...
 *
 * Usage:
 *   npx ts-node scripts/migrate-segment-orders.ts [--dry-run] [--routingId=XXX]
 *
 * Options:
 ...
 * Data Migration Script: Compute and persist segmentOrder for existing segments
 *
 * This script must be run from the services/backend directory:
 *   cd services/backend
 *   npx ts-node ../../scripts/migrate-segment-orders.ts [--dry-run] [--routingId=XXX]
 */
